...
def go(args):
    ...
    # Download the trainval artifact from W&B
    logger.info("Download the trainval artifact and read it")
    trainval_local_path = run.use_artifact(args.trainval_artifact).file()

    # Read the trainval artifact file 
    ...
    logger.info("Save the model's metrics")
...
def get_inference_pipeline(rf_config, max_tfidf_features):
    ...
    logger.info("Create the inference pipeline")
